...
- (void)launchImagePicker:(RNImagePickerTarget)target
{
    ...
    if (target == RNImagePickerTargetCamera) {
        ...
        if ([[self.options objectForKey:@"cameraModalStyle"] isEqualToString:@"fullScreen"]) {
            self.picker.modalPresentationStyle = UIModalPresentationFullScreen;
        }
        else if ([[self.options objectForKey:@"cameraModalStyle"] isEqualToString:@"pageSheet"]) {
            self.picker.modalPresentationStyle = UIModalPresentationPageSheet;
        }
        else if ([[self.options objectForKey:@"cameraModalStyle"] isEqualToString:@"formSheet"]) {
            self.picker.modalPresentationStyle = UIModalPresentationFormSheet;
        }
        else if ([[self.options objectForKey:@"cameraModalStyle"] isEqualToString:@"currentContext"]) {
            self.picker.modalPresentationStyle = UIModalPresentationCurrentContext;
        }
        else if ([[self.options objectForKey:@"cameraModalStyle"] isEqualToString:@"overCurrentContext"]) {
            self.picker.modalPresentationStyle = UIModalPresentationOverCurrentContext;
        }
        else if ([[self.options objectForKey:@"cameraModalStyle"] isEqualToString:@"overFullScreen"]) {
            self.picker.modalPresentationStyle = UIModalPresentationOverFullScreen;
        }
        else if ([[self.options objectForKey:@"cameraModalStyle"] isEqualToString:@"popover"]) {
        ...
        //'fullScreen' | 'pageSheet' | 'formSheet' | 'currentContext' | 'overCurrentContext' | 'overFullScreen' | 'popover';
        if ([[self.options objectForKey:@"libraryModalStyle"] isEqualToString:@"fullScreen"]) {
            self.picker.modalPresentationStyle = UIModalPresentationFullScreen;
        }
        else if ([[self.options objectForKey:@"libraryModalStyle"] isEqualToString:@"pageSheet"]) {
            self.picker.modalPresentationStyle = UIModalPresentationPageSheet;
        }
        else if ([[self.options objectForKey:@"libraryModalStyle"] isEqualToString:@"formSheet"]) {
            self.picker.modalPresentationStyle = UIModalPresentationFormSheet;
        }
        else if ([[self.options objectForKey:@"libraryModalStyle"] isEqualToString:@"currentContext"]) {
            self.picker.modalPresentationStyle = UIModalPresentationCurrentContext;
        }
        else if ([[self.options objectForKey:@"libraryModalStyle"] isEqualToString:@"overCurrentContext"]) {
            self.picker.modalPresentationStyle = UIModalPresentationOverCurrentContext;
        }
        else if ([[self.options objectForKey:@"libraryModalStyle"] isEqualToString:@"overFullScreen"]) {
            self.picker.modalPresentationStyle = UIModalPresentationOverFullScreen;
        }
        else if ([[self.options objectForKey:@"libraryModalStyle"] isEqualToString:@"popover"]) {
            self.picker.modalPresentationStyle = UIModalPresentationPopover;
        }
        else {
            self.picker.modalPresentationStyle = UIModalPresentationFullScreen;
